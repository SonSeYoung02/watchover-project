package com.chh.watchover.global.exception.assessment;
...
@RestControllerAdvice(basePackages = "com.chh.watchover.domain.assessment")
public class AssessmentExceptionHandler {

    /**
     * Assessment 도메인에서 발생한 커스텀 예외를 처리합니다.
     *
