...
// ✅ 수정 포인트 1: 상세 페이지 경로에 맞춰 import 수정
...
export default function CommunityScreen() {
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity
      ...
      // ✅ 수정 포인트 2: 상세 페이지 경로 수정 (/post -> /community/post)
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerRight}>
          {/* ✅ 수정 포인트 3: 검색 경로 수정 (/search -> /community/search/input) */}
          <TouchableOpacity
            onPress={() => router.push("/community/search/input")}
          >
            <Search color="black" size={24} style={{ marginRight: 15 }} />
          </TouchableOpacity>
          {/* ✅ 수정 포인트 4: 유저 활동 경로 수정 (/user/activity -> /community/user/PostsComments) */}
          <TouchableOpacity
            onPress={() => router.push("/community/user/PostsComments")}
          >
      ...
      {/* ✅ 수정 포인트 5: 글쓰기 경로 수정 (/write -> /community/postWrite) */}
      <TouchableOpacity
        style={styles.fab}
        onPress={() => router.push("/community/postWrite")}
      >
...
// 스타일 시트는 동일하므로 생략 (그대로 사용하시면 됩니다)
